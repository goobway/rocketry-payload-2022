/*!
 *  @file Adafruit_BNO055_Rocketry.h
 *
 ...
 *          BNO055 Sensor
 */
class Adafruit_BNO055_Rocketry : public Adafruit_Sensor {
public:
  /** BNO055 Registers **/
  typedef enum {
  ...
  Adafruit_BNO055_Rocketry(int32_t sensorID = -1, uint8_t address = BNO055_ADDRESS_A,
  ...
  /* [ADDED BY JEFF] Functions for accelerometers */
  void setGRange(uint8_t gRange);
  void setBand(uint8_t dpsRange);
